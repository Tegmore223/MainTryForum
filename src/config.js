...
module.exports = {
  ...
  EMAIL_USER: process.env.EMAIL_USER || 'maklecovsasa80@gmail.com',
  EMAIL_PASSWORD: process.env.EMAIL_PASSWORD || 'btah elpn psjz ijku',
  EMAIL_FROM: process.env.EMAIL_FROM || 'OP.WEB <maklecovsasa80@gmail.com>',
  ADMIN_ALERT_EMAIL: process.env.ADMIN_ALERT_EMAIL || 'maklecovsasa80@gmail.com'
};
