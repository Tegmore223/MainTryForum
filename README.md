...
Интерфейс использует сине‑серебристую палитру и многослойные панели в духе форумов начала 2000‑х (4chan/GameTrailers), но с современными отступами и сеткой. Доступны светлая и тёмная темы, переключатель расположен в правом верхнем углу.
